...
export const PillHeader: React.FC = () => {
  ...
  return (
    <header className="fixed top-4 md:top-6 left-0 right-0 z-[100] flex justify-center px-4 pointer-events-none">
      <nav className="flex items-center gap-2 px-3 md:px-4 py-2 rounded-full bg-background/70 backdrop-blur-xl border border-border/50 shadow-2xl max-w-full pointer-events-auto">
        {/* Logo/Brand */}
        <Link
          href="/"
          className="flex items-center gap-2 mr-2 md:mr-4 px-1 md:px-2"
        >
        ...
        <div className="flex items-center gap-1 ml-auto md:ml-2">
          <Link
            href={
              ...
              "https://github.com/Aryan3522/future-ui"
            }
            target="_blank"
