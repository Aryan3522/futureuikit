...
export const MigratedPreviews = {
  ...
  "dropdown-menu": function DropdownMenuPreview() {
    return (
      <PreviewContainer title="Dropdown Menu" description="Displays a menu to the user — such as a set of actions or functions — triggered by a button.">
        <div className="flex items-center justify-center min-h-[300px]">
          <DropdownMenu>
  ...
  "hover-card": function HoverCardPreview() {
    return (
      <PreviewContainer title="Hover Card" description="For sighted users to preview content available behind a link.">
        <div className="flex items-center justify-center min-h-[300px]">
          <HoverCard>
