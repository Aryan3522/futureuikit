...
export const SidebarButtonPreview: React.FC = () => {
  ...
  return (
    <PreviewContainer 
      ...
      description="Navigation button with active state and category styling for sidebars." 
      colors={DEFAULT_COLORS} 
      activeColor={previewColor} 
      onColorChange={setPreviewColor} 
      variants={["solid", "outline", "ghost", "link"]} 
    ...
    >
      <div className="w-full flex items-center justify-center p-4 md:p-12 min-h-75">
        <div className="w-full max-w-60 flex flex-col gap-1 p-4 bg-muted/20 rounded-xl">
          <SidebarButton label="Dashboard" isActive color={previewColor} variant={previewVariant} shape={previewShape} size={previewSize} spacing={previewSpacing} />
          <SidebarButton label="Analytics" color={previewColor} variant={previewVariant} shape={previewShape} size={previewSize} spacing={previewSpacing} />
          <SidebarButton label="Settings" color={previewColor} variant={previewVariant} shape={previewShape} size={previewSize} spacing={previewSpacing} />
          <div className="h-4" />
          <SidebarButton label="User Profile" isCategory color={previewColor} variant={previewVariant} shape={previewShape} size={previewSize} spacing={previewSpacing} />
          <SidebarButton label="Billing" isCategory color={previewColor} variant={previewVariant} shape={previewShape} size={previewSize} spacing={previewSpacing} />
        </div>
      </div>
    </PreviewContainer>
  );
  ...
  return (
    ...
    >
      <div className="w-full h-full min-h-125 relative overflow-hidden bg-muted/10 border border-border/50 rounded-xl" style={{ transform: "translateZ(0)" }}>
        <ComponentPageSidebar open={open} setOpen={setOpen} color={previewColor} variant={previewVariant} size={previewSize} spacing={previewSpacing} />
